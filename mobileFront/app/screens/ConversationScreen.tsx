...
export const ConversationScreen = () => {
  ...
  const renderMessage = ({ item }: { item: Message }) => {
    const isOwnMessage = item.sender_id === 'currentUserId'; // You'll need to get this from auth context
  ...
  return (
    ...
    >
      ...
      {/* Message Input */}
      <View className="flex-row items-center px-4 py-3 border-t border-gray-200 dark:border-gray-700">
        <TextInput
          value={newMessage}
