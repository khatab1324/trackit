...
export function SettingScreen() {
  ...
  const settings = [
    ...
    {
      icon: <Ionicons name="globe-outline" size={22} color="black" />,
      label: "Language",
      onPress: () => {},
    },
    {
      icon: <Feather name="edit-3" size={22} color="black" />,
      label: "Edit Bio",
      onPress: () => {},
    },
    {
  ...
  return (
    <View
      className={`flex-1 px-4 pt-14 ${isDarkMode ? "bg-black" : "bg-white"}`}
    >
      {/* Header */}
